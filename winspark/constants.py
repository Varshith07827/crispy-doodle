...
# What people type in front of the bot's name to address it in a chat, the way
# you'd say "@MetaAI" in WhatsApp: "!winspark what's the weather".
#
# "!" rather than "@" or "/", for two concrete reasons: typing "@" in WhatsApp
# opens the participant picker, and winSpark isn't a group member so it never
# appears there — friction on every single message. And "/" collides with text
# people really do send: "docs/winspark/readme.md", "http://x.com/winspark".
# "!" has neither problem.
AI_COMMAND_PREFIX = "!"
